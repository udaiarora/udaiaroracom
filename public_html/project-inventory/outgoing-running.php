...
<html>
	...
	<body>
		...
		<div class="main-content">
			...
			<div class="heading">
				Viewing item(s) in the outgoing inventory by running total and balance<a href="view-outgoing.php">(Click here to view all details)</a>
			</div>
			<form class="form-inline" method="get" action="outgoing-running.php">Filter By Date:
				<input id="date-range" type="text" class="input-large" placeholder="Date Range Select" name="date-range">
				<input id="msg-text" name="msg" style="display:none;" value="Filtered RUNNING TOTAL by date ( <a href='outgoing-running.php'>Remove</a> )"/>
		...
		<table id="view-incoming" class="table">
			...
			$q="SELECT DISTINCT item FROM outgoing_inventory WHERE date >= '".$sdate."' AND date <= '".$edate."'";
			...
			?>
				<tr>
		            ...
		            <td><?php echo round($runtotout[0],3)?></td>
